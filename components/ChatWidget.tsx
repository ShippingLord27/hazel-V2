...
export const ChatWidget = () => {
  ...
  const [localMessages, setLocalMessages] = useState<Array<{ content: string; isUser: boolean; timestamp: string }>>([])
  ...
  const handleSendMessage = async (messageText: string) => {
    ...
    if (isAiSupportChat) {
      const aiResponse = "Thank you for your message. Our support team will get back to you soon!"
  ...
  return (
    <div className={`chat-widget ${isChatOpen ? "open" : ""}`}>
      ...
      <div className="chat-input-area">
        ...
        />
        <button
          className="chat-send-message-btn"
